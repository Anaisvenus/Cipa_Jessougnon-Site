  ...
  return (
    <div className="AboutUs h-screen">
      ...
      <div className="h-screen flex flex-col justify-start items-center text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mb-20 px-10 md:px-20">
          {/* Première colonne */}
          <div className="bg-zinc-700 rounded-2xl p-8 md:p-10" style={{ height: 'auto', width: '100%' }}>
            ...
            <p className="text-lg md:text-2xl font-light">
              ...
              de grande affluence et de luxe.
            </p>
          </div>

          {/* Deuxième colonne */}
          <div className="bg-zinc-700 rounded-2xl p-8 md:p-10" style={{ height: 'auto', width: '100%' }}>
            <h1 className="text-4xl font-bold mb-4">Notre Vision</h1>
            <p className="text-lg md:text-2xl font-light">
        ...
        <h1 className="text-4xl font-bold mb-10 text-black font-bold text-6xl">Nos Valeurs</h1>

        {/* atouts */}
        <div className="grid grid-cols-2 gap-10 w-full rounded-2xl text-white text-2xl p-10 bg-zinc-700" style={{ width: '1400px'}}>
          {/* First Column */}
